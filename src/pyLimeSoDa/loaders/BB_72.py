"""
This module provides functionality to load the BB.72 dataset.

The BB.72 dataset contains soil samples from Brandenburg, Germany, with 72 reference soil samples.
"""
...
def load_BB_72() -> dict:
    """
    Load the BB.72 dataset from Brandenburg, Germany.
    ...
    Notes:
        - 72 soil samples from Brandenburg, Germany (3.4 ha study area)
        - Target variables (sampled August 2022, 0-30 cm depth):
    ...
    file_path = os.path.join(current_dir, 'data', 'BB_72.npz')
