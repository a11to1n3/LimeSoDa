"""
This module provides functionality to load the BB.51 dataset.

The BB.51 dataset contains soil samples from Brandenburg, Germany, with 51 reference soil samples.
"""
...
def load_BB_51() -> dict:
    """
    Load the BB.51 dataset from Brandenburg, Germany.
    ...
    Notes:
        - 51 soil samples from Brandenburg, Germany (40 ha study area)
        - Target variables (sampled September-November 2017, 0-30 cm depth):
    ...
    file_path = os.path.join(current_dir, 'data', 'BB_51.npz')
