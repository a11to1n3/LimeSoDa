"""
This module provides functionality to load the NRW_62 dataset.

The NRW_62 dataset contains soil samples from North Rhine-Westphalia, Germany, with 62 reference soil samples.
"""
...
def load_NRW_62() -> dict:
    """
    Load the NRW_62 dataset from North Rhine-Westphalia, Germany.
    ...
    Notes:
        - 62 soil samples from North Rhine-Westphalia, Germany (0.6 ha study area)
        - Target variables (sampled November 2017, 0-30 cm depth):
        ...
        - Features:
            - MIR (1686): Reflectance (%) at 3799-549.6 cm⁻¹, ~2 cm⁻¹ intervals
              From Bruker Tensor 27 spectrometer, lab measurements on <2mm samples
        - Coordinates omitted for privacy
        - Stratified systematic sampling of rectangular fertilizer treatment plots
        - Located on Pleistocene periglacial slope deposits from Upper Bunter sandstone
    """
    current_dir = os.path.dirname(os.path.dirname(__file__))
    file_path = os.path.join(current_dir, 'data', 'NRW_62.npz')
