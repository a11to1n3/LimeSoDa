"""
This module provides functionality to load the NRW_42 dataset.

The NRW_42 dataset contains soil samples from North Rhine-Westphalia, Germany, with 42 reference soil samples.
"""
...
def load_NRW_42() -> dict:
    """
    Load the NRW_42 dataset from North Rhine-Westphalia, Germany.
    ...
    Notes:
        - 42 soil samples from North Rhine-Westphalia, Germany (1.5 ha study area)
        - Target variables (sampled April 2013, 0-30 cm depth):
        ...
        - Located on Pleistocene periglacial slope deposits (weathered Devonian rocks)
    """
    current_dir = os.path.dirname(os.path.dirname(__file__))
    file_path = os.path.join(current_dir, 'data', 'NRW_42.npz')
