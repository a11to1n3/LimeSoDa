"""
This module provides functionality to load the G_104 dataset.

The G_104 dataset contains soil samples from Goias, Brazil, with 104 reference soil samples.
"""
...
def load_G_104() -> dict:
    """
    Load the G_104 dataset from Goias, Brazil.
    ...
    Notes:
        - 104 soil samples from Goias, Brazil (95 ha study area)
        - Target variables (sampled July 2022, 0-20 cm depth):
        ...
        - Located on heavily weathered sedimentary rocks (claystone, sandstone)
    """
    current_dir = os.path.dirname(os.path.dirname(__file__))
    file_path = os.path.join(current_dir, 'data', 'G_104.npz')
