"""
Lime_SoDa: Precision Liming Soil Datasets

This package provides access to a collection of soil datasets for precision liming applications.
It includes 30 datasets with soil properties and features for modeling purposes.

The main goals of Lime_SoDa are:
...
Each dataset in Lime_SoDa contains:
